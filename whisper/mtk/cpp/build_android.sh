...
echo "========================================"
echo "Whisper KV Cache - Build Script"
echo "========================================"
...
echo "========================================"
echo "Executable: libs/arm64-v8a/whisper_kv_test"
echo ""
ls -lh libs/arm64-v8a/whisper_kv_test 2>/dev/null || echo "Binary not found"
echo ""
