...
EASYLOGGINGPP_THIS_DIR:=$(patsubst $(LOCAL_PATH)\\%,%,$(patsubst $(LOCAL_PATH)/%,%,$(call my-dir)))
EASYLOGGINGPP_LOCAL_C_INCLUDES:="$(LOCAL_PATH)/$(EASYLOGGINGPP_THIS_DIR)/include"

include $(CLEAR_VARS)

LOCAL_MODULE := easyloggingpp
LOCAL_SRC_FILES := $(EASYLOGGINGPP_THIS_DIR)/easylogging++.cc
LOCAL_CFLAGS += -D__ANDROID__
LOCAL_C_INCLUDES += $(EASYLOGGINGPP_LOCAL_C_INCLUDES)
