...
private:
    ...
    int d_model_ = 512;        // n_text_state: 384(tiny), 512(base), 768(small), 1024(medium), 1280(large)
    int num_layers_ = 6;       // n_text_layer: 4(tiny), 6(base), 12(small), 24(medium), 32(large)
